  ...
  (t.prototype = {
    ...
    radius: function (t, i) {
      ...
      return (
        ...
        (e.shadowColor = "black"),
        e.beginPath(),
        e.arc(s - 200, s - 200, t, 0, 2 * Math.PI, !0),
        e.closePath(),
        e.fill(),
        this
      );
    ...
    _colorize: function (t, i) {
      for (var a, e = 3, s = t.length; s > e; e += 4)
        (a = 4 * t[e]),
          a &&
            ((t[e - 3] = i[a]), (t[e - 2] = i[a + 1]), (t[e - 1] = i[a + 2]));
    },
  }),
    (window.simpleheat = t);
})() /*
...
*/,
  (L.HeatLayer = L.Class.extend({
    ...
    _initCanvas: function () {
      ...
      L.DomUtil.addClass(t, "leaflet-zoom-" + (a ? "animated" : "hide")),
    ...
    _redraw: function () {
      var t,
        ...
        d = this._heat._r,
        l = this._map.getSize(),
        m = new L.LatLngBounds(
          this._map.containerPointToLatLng(L.point([-d, -d])),
          this._map.containerPointToLatLng(l.add([d, d]))
        ),
        c =
      ...
      for (t = 0, i = this._latlngs.length; i > t; t++)
        m.contains(this._latlngs[t]) &&
          ((a = this._map.latLngToContainerPoint(this._latlngs[t])),
          (s = Math.floor((a.x - v) / g) + 2),
          (n = Math.floor((a.y - w) / g) + 2),
          (r = (this._latlngs[t].alt || 1) * u),
          (f[n] = f[n] || []),
          (e = f[n][s]),
          e
            ? ((e[0] = (e[0] * e[2] + a.x * r) / (e[2] + r)),
              (e[1] = (e[1] * e[2] + a.y * r) / (e[2] + r)),
              (e[2] += r))
            : (f[n][s] = [a.x, a.y, r]));
      for (t = 0, i = f.length; i > t; t++)
        if (f[t])
          for (h = 0, o = f[t].length; o > h; h++)
            (e = f[t][h]),
              e &&
                _.push([Math.round(e[0]), Math.round(e[1]), Math.min(e[2], 1)]);
