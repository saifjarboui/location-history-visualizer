!(function (a, b, c, d, e, f) {
  ...
  function C(a) {
    ...
    function b() {
      var a = 0;
      P.length > p &&
        (c("Max buffer length exceeded: textNode"),
        (a = Math.max(a, P.length))),
        Q.length > p &&
          (c("Max buffer length exceeded: numberNode"),
          (a = Math.max(a, Q.length))),
        (O = p - a + Y);
    }
    function c(a) {
      P && (m(P), n(), (P = "")),
              ...
              a: for (;;) {
                for (; W > 0; )
                  if (
                    ...
                    (j = a.charAt(d++)),
                    4 === W
                      ? ((P += String.fromCharCode(parseInt(V, 16))),
                        (W = 0),
                        (e = d - 1))
                      : W++,
                    !j)
  ...
  function F(a, b) {
    ...
    return !!(
      (b.protocol && b.protocol != a.protocol) ||
  ...
  function G(a) {
    var b = /(\w+:)?(?:\/\/)([\w.-]+)?(?::(\d+))?\/?/,
      c = b.exec(a) || [];
    return { protocol: c[1] || "", host: c[2] || "", port: c[3] || "" };
  }
  function H() {
  ...
  function I(b, c, d, e, g, h, i) {
    ...
    b(pb).on(function () {
      ...
      "onprogress" in c && (c.onprogress = j),
  ...
  function N(a, b, c) {
    ...
    return { statusCode: a, body: b, jsonBody: d, thrown: c };
  }
  function O(a, b) {
    function c(a, b, c) {
      var d = A(c);
    ...
    function d(b, d, e) {
      ...
      d.on(function (a) {
        ...
        a("removeListener").on(function (c) {
          c == b && (a(c).listeners() || d.un(b));
        });
    }
    var e = { node: a(gb), path: a(fb) };
  ...
  function R(a, b, c, d, f, g, h) {
    ...
    return (
      (f = f ? e.parse(e.stringify(f)) : {}),
      d
        ? W(d) ||
          ((d = e.stringify(d)),
          (f["Content-Type"] = f["Content-Type"] || "application/json"))
        : (d = null),
  ...
  function S(a) {
    ...
    return a
      ? c(a) || W(a)
        ? R(Q, a)
        : R(Q, a.url, a.method, a.body, a.headers, a.withCredentials, a.cached)
      : Q();
  }
